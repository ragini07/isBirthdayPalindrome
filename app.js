var bdayInput = document.querySelector('#birthdateinput');
...
function clickHandler() {
  ...
  if (bdayString !== '') {
    ...
    if (!isPalindrome) {
      ...
      if (ctr2 < ctr1) {
        day = (ctr2 == 1) ? 'day' : 'days';
        output.innerText = `The nearest palindrome date is ${prevDate.day}-${prevDate.month}-${prevDate.year}, you missed by ${ctr2} ${day}`;
      } else {
        day = (ctr1 == 1) ? 'day' : 'days';
        output.innerText = `The nearest palindrome date is ${nextDate.day}-${nextDate.month}-${nextDate.year}, you missed by ${ctr1} ${day}.`;
      }
    ...
    output.innerText = 'Please provide your birthdate';
  }
}
